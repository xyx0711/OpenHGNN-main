...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-m', default='AEHCL', type=str, help='name of models')
    parser.add_argument('--task', '-t', default='abnorm_event_detection', type=str, help='name of task')
    # link_prediction / node_classification
    parser.add_argument('--dataset', '-d', default='aminer', type=str, help='name of datasets')
